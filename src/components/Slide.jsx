...
export default function Slide({ data: { url, title } }) {
  return (
    <div className="slide flex-[1_0_100%] justify-center flex">
      <div class="polaroid w-[42%] h-[100%]">
        <div class="polaroid-frame relative bg-white rounded-md max-w-[100%] px-[6%] pt-[6%] pb-[17%] shadow-lg">
          <img
            src={url}
            alt={title}
            class="block border-black border-2 rounded-lg shadow-lg"
          />
        </div>
      </div>
